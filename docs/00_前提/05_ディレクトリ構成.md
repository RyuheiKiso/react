...
│           │   │   ├── ProgressBar.tsx        // プログレスバー機能の共通コンポーネント
│           │   │   ├── Table.tsx              // テーブル機能の共通コンポーネント
│           │   │   ├── Timer.tsx              // タイマー機能の共通コンポーネント
│           │   │   ├── QRGenerator.tsx        // QR生成機能の共通コンポーネント
...
│           │   ├── grid
│           │   │   └── Grid.tsx               // gridデザインの共通コンポーネント
│           │   ├── camera
│           │   │   └── Camera.tsx             // カメラ機能の共通コンポーネント
│           │   ├── error
